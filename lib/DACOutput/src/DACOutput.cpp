...
void DACOutput::start(SampleSource *sample_generator, int iTimer)
{
...
void DACOutput::stop()
{
    ...
    Serial.println("delete task");
    vTaskDelete( writerTaskHandle );
}

void DACOutput::suspend()
{
...
{
    Serial.println("suspend called");
    vTaskResume( writerTaskHandle );
}


TaskHandle_t DACOutput::getTaskHandle()
{
    return this->m_i2sWriterTaskHandle;
}
